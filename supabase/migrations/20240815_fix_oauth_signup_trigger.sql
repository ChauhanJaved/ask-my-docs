-- ============================================================================
-- Fix Google OAuth New User Signup Trigger & Robust Organization Creation
-- ============================================================================
...
BEGIN
    ...
    ELSE
        ...
        -- Generate guaranteed unique slug by appending 8 characters from NEW.id UUID
...
EXCEPTION WHEN OTHERS THEN
    -- Log warning so trigger failures don't silently abort without trace, but allow trigger return
